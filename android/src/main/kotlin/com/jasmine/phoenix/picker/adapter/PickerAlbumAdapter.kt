package com.jasmine.phoenix.picker.adapter
...
class PickerAlbumAdapter(private val mContext: Context) : RecyclerView.Adapter<PickerAlbumAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            first_image = itemView.findViewById<ImageView>(R.id.first_image) as ImageView
            tv_folder_name = itemView.findViewById<TextView>(R.id.tv_folder_name) as TextView
            image_num = itemView.findViewById<TextView>(R.id.image_num) as TextView
            tv_sign = itemView.findViewById<TextView>(R.id.tv_sign) as TextView
        }
    }
