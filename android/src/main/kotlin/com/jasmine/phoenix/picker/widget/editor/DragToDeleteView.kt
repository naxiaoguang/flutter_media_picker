package com.jasmine.phoenix.picker.widget.editor
...
import com.jasmine.phoenix.picker.util.OnLayoutRectChange
...
class DragToDeleteView(private val view: View) {
    ...
    init {
        ...
        mTextView = view.findViewById<TextView>(R.id.tvDragDelete) as TextView
    }
