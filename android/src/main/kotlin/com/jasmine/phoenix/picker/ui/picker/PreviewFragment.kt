...
import com.jasmine.phoenix.picker.listener.OnPictureEditListener
...
import com.jasmine.phoenix.picker.ui.editor.PictureEditFragment
import com.jasmine.phoenix.picker.util.*
import com.jasmine.phoenix.picker.widget.photoview.PhotoView
import com.jasmine.phoenix.picker.widget.videoview.PhoenixVideoView
...
class PreviewFragment : BaseFragment(), View.OnClickListener, Animation.AnimationListener, OnPictureEditListener {
    ...
    private inner class SimpleFragmentAdapter : PagerAdapter() {
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            ...
            val preview_video = contentView.findViewById<PhoenixVideoView>(R.id.preview_video)
