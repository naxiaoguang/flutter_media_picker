package com.jasmine.phoenix.picker.widget.videoview
...
import com.jasmine.phoenix.picker.widget.dialog.PhoenixLoadingDialog
...
class PhoenixVideoView : RelativeLayout {
    ...
    private fun setupView() {
        ...
        videoView = videoLayout.findViewById<InternalVideoView>(R.id.video_view) as InternalVideoView
        seekbarProgress = videoLayout.findViewById<SeekBar>(R.id.seekbar_progress) as SeekBar
        ivPlay = videoLayout.findViewById<ImageView>(R.id.iv_play) as ImageView
        tvCurrentProgress = videoLayout.findViewById<TextView>(R.id.tv_currentProgress) as TextView
        tvTotalProgress = videoLayout.findViewById<TextView>(R.id.tv_totalProgress) as TextView
        llController = videoLayout.findViewById<TextView>(R.id.ll_controller) as LinearLayout
        flContainer = videoLayout.findViewById<FrameLayout>(R.id.rl_container) as FrameLayout
        ivCenterPlay = findViewById<ImageView>(R.id.iv_center_play) as ImageView
    }
